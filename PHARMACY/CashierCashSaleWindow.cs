...
namespace PHARMACY
{
    ...
    {
        // Calculator properties start here
        Double results = 0;
        String operation = "";
        ...
        public void drugForeignKey()
        {
            ...
            {
                MessageBox.Show("drug foreign key error ",ex.Message);
            }
        ...
        public void computeBalance()
        {
            try
            {
                ...
                {
                    MessageBox.Show("No Drug Found!","DRUG NOT FOUND",MessageBoxButtons.OK,MessageBoxIcon.Exclamation);
                }
        ...
        public void updateNetStock()
        {
            ...
            catch (Exception)
            {
                ...
                MessageBox.Show("Problem has occured while updating net stock","NET STOCK UPDATE ERROR" ,MessageBoxButtons.OK,MessageBoxIcon.Exclamation);
            }
            finally
            { 
        ...
        public void insertToSales()
        {
            ...
            try
            {
                ...
                updateNetStock();
                //cashSaleDelete();
                MessageBox.Show("SUCCESS","DRUG SALE",MessageBoxButtons.OK,MessageBoxIcon.Information);
            ...
            {
               // MessageBox.Show("Error inserting into cart ",ex.Message);
            }
            finally
            { 
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("No Drug","DRUG NOT FOUND",MessageBoxButtons.OK,MessageBoxIcon.Exclamation);
                cashSaleDrugSearch.Select();
            }
        }
        ...
        public void print(object sender, EventArgs e)
        {
            try
            {
             ...
             //   DialogResult result = printDialog.ShowDialog();
              ...
              //  result = MessageBox.Show("Do you want to print a recipt ? ", "PRINT RECEIPT", MessageBoxButtons.OK, MessageBoxIcon.Question);
            ...
            {
               MessageBox.Show("Something wrong has occured while printing a receipt. ", "RECEIPT PRINTING ERROR", MessageBoxButtons.RetryCancel, MessageBoxIcon.Error);
            }
            finally
            { 
     ...
     // Calculator module begins here.
        ...
        private void CashierCashSaleWindow_KeyDown(object sender, KeyEventArgs e)
        {
